...
function PriceCard({
  ...
  return (
    <div className="border border-solid border-washed-purple/washed-purple-700 rounded-2xl px-6 py-[50px] flex flex-col w-[330px]">
      ...
      <div className="flex flex-col">
        ...
        {line2 && <div className="text-neutral/neutral-8 text-xs">{line2}</div>}
        <div className="py-5">
