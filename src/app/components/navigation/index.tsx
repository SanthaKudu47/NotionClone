...
function Navigation() {
  return (
    <div className="fixed z-50 top-0 bg-brand/brand-dark flex flex-row w-full px-2 sm:px-5 h-[70px] border-b border-b-solid border-opacity-50 border-washed-purple/washed-purple-800">
      <div className="flex flex-row justify-between sm:justify-evenly items-center text-white h-full w-full">
        ...
        <div className="hidden sm:inline-block w-full  px-10">
          <ul className="text-xs flex flex-row justify-between max-w-[800px] mx-auto border-2 border-washed-purple/washed-purple-700 border-opacity-30  border-solid py-2 px-4 rounded-3xl">
            <li>
              <Link href={"#express"}>Cypress</Link>
            </li>
            <li>
            ...
            <li>
              <Link href={"#download"}>Get Cypress</Link>
            </li>
          </ul>
        </div>
        <div className="flex flex-row gap-x-4 items-center flex-shrink-0">
          <div className="hidden sm:flex"><UserProfile /></div>
         <div className="flex sm:hidden"><MobileNav /></div> 
        </div>
        {/* <div className="hidden sm:flex flex-row gap-x-4 items-center flex-shrink-0">
          <MobileNav />
        </div> */}
      </div>
    </div>
